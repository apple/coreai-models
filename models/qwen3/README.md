...
| Qwen3 1.7B | none (`float16`)                                     | 16.00                 | iOS      | 20.96            |
| Qwen3 1.7B | [Mixed 4-bit/8-bit palettized][qwen3-1.7b-mixed-yaml] | 5.43\*                | iOS      | 21.19            |
...
[qwen3-1.7b-mixed-yaml]: qwen3_1_7b_mixed_4bit_8bit.yaml
