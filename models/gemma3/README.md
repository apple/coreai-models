...
| ----------- | ------------------------- | -------- | ---------------- | --------------------- |
| Gemma 3 4B  | none (`float16`)          | macOS    | 17.90            | 16.00                 |
| Gemma 3 4B  | [4-bit quantized][p-4bit] | macOS    | 19.28            | 4.50                  |
| Gemma 3 12B | none (`float16`)          | macOS    | 11.24            | 16.00                 |
| Gemma 3 12B | [4-bit quantized][p-4bit] | macOS    | 11.75            | 4.50                  |
